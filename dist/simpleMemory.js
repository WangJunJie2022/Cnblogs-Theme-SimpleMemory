 ...
 */
			...
			function() {
				...
				var ct = {};
				ct[y] = ct[m] = ct[$] = ct[L] = ct[b] = ct[j] = ct[B] = ct[D] = ct[M] = ct[W] = ct[N] = ct[A] = ct[S] = ct[E] = ct[z] = ct[I] = ct[T] = ct[C] = ct[U] = ct[P] = ct[F] = ct[q] = !0,
				ct[w] = ct[k] = ct[R] = !1;
				var st = {
					"\\": "\\",
					"'": "'",
				...
				var dr = function n(t) {
					...
					function Qr(n, t) {
						...
						a = o ? Yt(n.length, In) : [],
						c = a.length;
						for (var s in n) ! t && !Dn.call(n, s) || o && ("length" == s || u && ("offset" == s || "parent" == s) || i && ("buffer" == s || "byteLength" == s || "byteOffset" == s) || bi(s, c)) || a.push(s);
						return a
					}
					function Xr(n) {
						var t = n.length;
					...
					function ci(n) {
						for (var t = n.name + "",
						r = Rr[t], e = Dn.call(Rr, t) ? r.length: 0; e--;) {
							var u = r[e],
							i = u.func;
					...
					var Ea = Qe((function(n, t) {
						...
						for (i && ji(t[0], t[1], i) && (e = 1); ++r < e;) for (var o = t[r], a = La(o), c = -1, s = a.length; ++c < s;) {
							var l = a[c],
							f = n[l]; (f === u || Fo(f, $n[l]) && !Dn.call(n, l)) && (n[l] = o[l])
						}
						return n
					})),
					Oa = Qe((function(n) {
		...
		1793 : function(n, t, r) {
			...
			var e = r(6486),
			u = r.n(e),
			i = JSON.parse('{"info":{"name":"WangJunjie","startDate":"2018-01-01","avatar":"",
			"blogIcon":"https://blog.dbnuo.com/images/favicon-32x32-next.png"},
			"sidebar":{"navList":[],"customList":{},"infoBackground":""},
			...
			"loading":{"rebound":{"tension":16,"friction":5},
			"spinner":{"id":"spinner","radius":90,"sides":3,"depth":4,
			"colors":{"background":"#f0f0f0","stroke":"#272633","base":null,"child":"#272633"},
			"alwaysForward":true,"restAt":0.5,"renderBase":false}},"fontIconExtend":"//at.alicdn.com/t/font_8d5l8fzk5b87iudi.js",
			"progressBar":{"id":"top-progress-bar","color":"#77b6ff","height":"2px","duration":0.2},
			"title":{"onblur":"(oﾟvﾟ)ノ Hi","onblurTime":500,"focus":"(*´∇｀*) 欢迎回来！","focusTime":1000},
			"footer":{"text":{"left":"好好学习","right":"天天向上","iconFont":{"icon":"icon-xl","color":"red","fontSize":"16px"}},
			"style":2},
			"links":{"footer":[],"page":[]},"cnzz":"1280451493","rtMenu":{"qrCode":"",
			"reward":{"alipay":"https://cdn.jsdelivr.net/gh/15680603296/picture@main/alipay.jpg",
			"wechatpay":"https://cdn.jsdelivr.net/gh/15680603296/picture@main/weixinpay.jpg"},
			"downScrollDom":"#blog_post_info_block"},
			"switchDayNight":{"enable":true,"nightMode":false,"auto":{"enable":true,
			"dayHour":5,"nightHour":19}},
			"animate":{"bannerImages":{"enable":true,
			"options":{"itemNum":5,"current":0,"sort":1,"time":30000}},
			"homeBanner":{"enable":true,"options":{"radius":15,"density":0.2,
			"color":"rgba(255,255,255, .2)",
			"clearOffset":0.3}},"articleTitle":{"enable":true},
			"articleBanner":{"enable":false},
			"background":{"enable":true,
			"options":{"colorSaturation":"60%","colorBrightness":"50%","colorAlpha":0.5,"colorCycleSpeed":5,"verticalPosition":"random","horizontalSpeed":200,"ribbonCount":3,"strokeSize":0,"parallaxAmount":-0.2,"animateSections":true}},
			"backgroundMouse":{"enable":true},"mouse":{"enable":true,"options":{"size":8,"sizeF":36}}},
			"code":{"type":"hljs","options":{"hljs":{"theme":"atom-one-dark-reasonable",
			"languages":['Bash ', 'CSS ', 'Dockerfile ', 'Go ', 'HTML ', 'XML ', 'HTTP ']},
			"maxHeight":"70vh","line":true,"macStyle":true}},
			"articleSuffix":{"imgUrl":"","aboutHtml":"I am a good person","copyrightHtml":"","supportHtml":""},
			"articleDirectory":{"position":"right","minBodyWeight":1350,"autoWidthScroll":true},
			"consoleList":[
			    ['My CNBlogs ', 'https: //www.cnblogs.com/wangjunjiehome/'],
			['My Email', '1129405725@qq.com'], ],
			"bookList": [],
			"hooks": {}
		}
		');
